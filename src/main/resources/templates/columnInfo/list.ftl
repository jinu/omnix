                                        ...
                                        <tfoot id="template" style="display:none;">
                                            <tr key="[[ id ]]">
                                                ...
                                                <td class="with-btn" nowrap="">
                                                    <a href="/columnInfo/edit/${table.id}/[[ id ]]" class="btn btn-sm btn-primary width-60 m-r-2">Edit</a>
...
$(document).ready(function() {
    ...
    $('#listContent').on('click', '.deleteBtn', function() {
        ...
        var url = '/restapi/columnInfo/' + TABLE_ID + '/del/' + id;
        var returnUrl = '/columnInfo/list/' + TABLE_ID;
